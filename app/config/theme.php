...
return [
    ...
    'views' => [
        [
            'region' => 'topbar',
            'template' => 'teso/topbar',
            'data' => [],
            'sort' => -1
        ],    
        [
            'region' => 'header',
            'template' => 'teso/header',
            'data' => [
                'siteTitle' => "The Elder Scrolls Oracle",
                'siteTagline' => "A Q+A site concerning everything Elder Scrolls",
            ],
            'sort' => -1
        ],
        [
            'region' => 'footer', 
            'template' => 'teso/footer', 
            'data' => [], 'sort' => -1
        ],
        [
            'region' => 'navbar',
    ...
    'data' => [
        ...
        // Stylesheets
        'stylesheets' => ['css/style.css','css/navbar.css','css/font-awesome-4.2.0/css/font-awesome.min.css'],
